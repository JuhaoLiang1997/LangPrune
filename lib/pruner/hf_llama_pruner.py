...
from lib.torch_pruning import BasePruningFunc, ops
...
class HFAttentionPrunner(BasePruningFunc):
    ...
    def get_out_channels(self, layer):
        # Qwen3 doesn't have .hidden_size, but LLaMA does.
        # Both models have o_proj, so we get the dimension from o_proj.
        return layer.o_proj.out_features

    def get_in_channels(self, layer):
        # Both LLaMA and Qwen3's o_proj.in_features equals hidden_size
        return layer.o_proj.in_features
