...
def flatten_as_list(obj):
    # Handle CausalLMOutputWithPast and other similar named tuples
    if isinstance(obj, (transformers.modeling_outputs.CausalLMOutputWithPast, transformers.modeling_outputs.BaseModelOutputWithPast)):
        # Extract the logits tensor, which is the main output
        return flatten_as_list(obj.logits)
